...
class ViewInvestmentbonds extends StatefulWidget {
  ...
  const ViewInvestmentbonds({
    super.key,
    required this.investment,
  });

  @override
  State<ViewInvestmentbonds> createState() =>
      _ViewInvestmentbondsState();
}

class _ViewInvestmentbondsState
    extends State<ViewInvestmentbonds> {
  ...
  void initState() {
    ...
    _investmentFuture =
        ApiService.getInvestmentById(widget.investment.id);

    //_payoutsFuture =
    //    ApiService.getPayouts(widget.investment.id);
  }
